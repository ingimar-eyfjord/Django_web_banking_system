...
class Command(BaseCommand):
    def handle(self, **options):
        ...
        bank_user = User.objects.create_user(BANK_NAME, email='', password=secrets.token_urlsafe(64))
        ...
        bank_two_number = BankUID.uid
        bank = Banks.objects.create(bank_number=bank_number, bank_name = "PayLater", bank_ip_address="ingimar.dk:8000")
        Banks.objects.create(bank_number=bank_two_number, bank_name = "PayNow", bank_ip_address="ingimar.dk:8060")
